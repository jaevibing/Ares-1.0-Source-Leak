...
{
    public static final Map<String, Object> UNICODE_OPTIONS = Collections.<String, Object>unmodifiableMap((Map<? extends String, ?>)new HashMap<String, Object>() {
    ...
    public static final Map<String, Object> ASCII_OPTIONS = Collections.<String, Object>unmodifiableMap((Map<? extends String, ?>)new HashMap<String, Object>() {
        private static final long serialVersionUID = 1L;
