...
public final class SecurityTestUtils
{
    ...
    public static byte[] newEncodedRsaPrivateKeyBytes() {
        /*SL:86*/return SecurityTestUtils.ENCODED_PRIVATE_KEY.clone();
    }
    
    public static byte[] newEncodedRsaPublicKeyBytes() {
        /*SL:94*/return SecurityTestUtils.ENCODED_PUBLIC_KEY.clone();
    }
    
    public static RSAPrivateKey newRsaPrivateKey() throws GeneralSecurityException {
        final KeyFactory v1 = /*EL:99*/SecurityUtils.getRsaKeyFactory();
        final KeySpec v2 = /*EL:100*/new PKCS8EncodedKeySpec(SecurityTestUtils.ENCODED_PRIVATE_KEY);
        /*SL:101*/return (RSAPrivateKey)v1.generatePrivate(v2);
    }
    
    public static RSAPublicKey newRsaPublicKey() throws GeneralSecurityException {
        final KeyFactory v1 = /*EL:106*/SecurityUtils.getRsaKeyFactory();
        final KeySpec v2 = /*EL:107*/new X509EncodedKeySpec(SecurityTestUtils.ENCODED_PUBLIC_KEY);
        /*SL:108*/return (RSAPublicKey)v1.generatePublic(v2);
    }
