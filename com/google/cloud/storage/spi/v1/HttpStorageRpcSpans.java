...
class HttpStorageRpcSpans
{
    ...
    static String getTraceSpanName(final String a1) {
        /*SL:145*/return String.format("%s.%s.%s", "Sent", HttpStorageRpc.class.getName(), /*EL:146*/a1);
    }
    
    static void registerAllSpanNamesForCollection() {
        /*SL:150*/Tracing.getExportComponent().getSampledSpanStore().registerSpanNamesForCollection((Collection)HttpStorageRpcSpans.ALL_SPAN_NAMES);
    }
