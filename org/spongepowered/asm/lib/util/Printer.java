...
public abstract class Printer
{
    ...
    public Printer visitClassTypeAnnotation(final int a1, final TypePath a2, final String a3, final boolean a4) {
        /*SL:257*/throw new RuntimeException("Must be overriden");
    }
    ...
    public Printer visitFieldTypeAnnotation(final int a1, final TypePath a2, final String a3, final boolean a4) {
        /*SL:457*/throw new RuntimeException("Must be overriden");
    }
    ...
    public void visitParameter(final String a1, final int a2) {
        /*SL:491*/throw new RuntimeException("Must be overriden");
    }
    ...
    public Printer visitMethodTypeAnnotation(final int a1, final TypePath a2, final String a3, final boolean a4) {
        /*SL:535*/throw new RuntimeException("Must be overriden");
    }
    ...
    public void visitMethodInsn(final int a3, final String a4, final String v1, final String v2) {
        /*SL:762*/if (this.api >= 327680) {
            final boolean a5 = /*EL:763*/a3 == 185;
            /*SL:764*/this.visitMethodInsn(a3, a4, v1, v2, a5);
            /*SL:765*/return;
        }
        /*SL:767*/throw new RuntimeException("Must be overriden");
    }
    
    public void visitMethodInsn(final int a1, final String a2, final String a3, final String a4, final boolean a5) {
        /*SL:790*/if (this.api >= 327680) {
            /*SL:798*/throw new RuntimeException("Must be overriden");
        }
        if (a5 != (a1 == 185)) {
    ...
    public Printer visitInsnAnnotation(final int a1, final TypePath a2, final String a3, final boolean a4) {
        /*SL:980*/throw new RuntimeException("Must be overriden");
    }
    ...
    public Printer visitTryCatchAnnotation(final int a1, final TypePath a2, final String a3, final boolean a4) {
        /*SL:1025*/throw new RuntimeException("Must be overriden");
    }
    ...
    public Printer visitLocalVariableAnnotation(final int a1, final TypePath a2, final Label[] a3, final Label[] a4, final int[] a5, final String a6, final boolean a7) {
        /*SL:1089*/throw new RuntimeException("Must be overriden");
    }
    ...
    public List<Object> getText() {
        /*SL:1130*/return this.text;
    }
    
    public void print(final PrintWriter a1) {
        printList(/*EL:1140*/a1, this.text);
    }
    
    public static void appendString(final StringBuffer v1, final String v2) {
        /*SL:1152*/v1.append('\"');
        /*SL:1153*/for (char a2 = 0; a2 < v2.length(); ++a2) {
            /*SL:1154*/a2 = v2.charAt(a2);
            /*SL:1155*/if (a2 == '\n') {
                /*SL:1156*/v1.append("\\n");
            }
            else/*SL:1157*/ if (a2 == '\r') {
                /*SL:1158*/v1.append("\\r");
            }
            else/*SL:1159*/ if (a2 == '\\') {
                /*SL:1160*/v1.append("\\\\");
            ...
            else/*SL:1163*/ if (a2 < ' ' || a2 > '\u007f') {
                /*SL:1164*/v1.append("\\u");
                /*SL:1165*/if (a2 < '\u0010') {
                    /*SL:1166*/v1.append("000");
                }
                else/*SL:1167*/ if (a2 < '\u0100') {
                    /*SL:1168*/v1.append("00");
                }
                else/*SL:1169*/ if (a2 < '\u1000') {
                    /*SL:1170*/v1.append('0');
                }
                /*SL:1172*/v1.append(Integer.toString(a2, 16));
            }
            else {
                /*SL:1174*/v1.append(a2);
            }
        }
        /*SL:1177*/v1.append('\"');
    }
    ...
    static void printList(final PrintWriter v1, final List<?> v2) {
        /*SL:1190*/for (Object a2 = 0; a2 < v2.size(); ++a2) {
            /*SL:1191*/a2 = v2.get(a2);
            /*SL:1192*/if (a2 instanceof List) {
                printList(/*EL:1193*/v1, (List<?>)a2);
            }
            else {
                /*SL:1195*/v1.print(a2.toString());
            }
        }
    }
