...
public class JumpInsnPoint extends InjectionPoint
{
    ...
    public boolean find(final String a3, final InsnList v1, final Collection<AbstractInsnNode> v2) {
        boolean v3 = /*EL:86*/false;
        int v4 = /*EL:87*/0;
        /*SL:89*/for (final AbstractInsnNode a4 : v1) {
            /*SL:93*/if (a4 instanceof JumpInsnNode && (this.opCode == -1 || a4.getOpcode() == this.opCode)) {
                /*SL:94*/if (this.ordinal == -1 || this.ordinal == v4) {
                    /*SL:95*/v2.add(a4);
                    /*SL:96*/v3 = true;
                }
                /*SL:99*/++v4;
