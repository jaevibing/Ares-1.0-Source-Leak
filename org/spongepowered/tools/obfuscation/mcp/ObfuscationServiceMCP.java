...
public class ObfuscationServiceMCP implements IObfuscationService
{
    ...
    public Set<String> getSupportedOptions() {
        /*SL:54*/return ImmutableSet.<String>of("reobfSrgFile", "reobfSrgFiles", "reobfNotchSrgFile", "reobfNotchSrgFiles", "outSrgFile", "outNotchSrgFile", "outRefMapFile");
    }
    
    @Override
    public Collection<ObfuscationTypeDescriptor> getObfuscationTypes() {
        /*SL:67*/return ImmutableList.<ObfuscationTypeDescriptor>of(new ObfuscationTypeDescriptor("searge", "reobfSrgFile", "reobfSrgFiles", "outSrgFile", ObfuscationEnvironmentMCP.class), new ObfuscationTypeDescriptor("notch", "reobfNotchSrgFile", "reobfNotchSrgFiles", "outNotchSrgFile", ObfuscationEnvironmentMCP.class));
    }
}
