...
public class ConstantAttribute extends AttributeInfo
{
    ...
    public int getConstantValue() {
        /*SL:57*/return ByteArray.readU16bit(this.get(), 0);
    }
    
    @Override
    public AttributeInfo copy(final ConstPool a1, final Map a2) {
        final int v1 = /*EL:69*/this.getConstPool().copy(this.getConstantValue(), a1, a2);
        /*SL:71*/return new ConstantAttribute(a1, v1);
    }
}
