...
public class Visitor
{
    ...
    public void atMethodDecl(final MethodDecl a1) throws CompileError {
    }
    
    public void atStmnt(final Stmnt a1) throws CompileError {
    }
    
    public void atDeclarator(final Declarator a1) throws CompileError {
    }
    ...
    public void atBinExpr(final BinExpr a1) throws CompileError {
    }
    
    public void atExpr(final Expr a1) throws CompileError {
    }
    
    public void atCallExpr(final CallExpr a1) throws CompileError {
    }
    ...
    public void atNewExpr(final NewExpr a1) throws CompileError {
    }
